...
void main() {
 ...
 skyColor += pow(vec3_splat(star(sPos.zx*45.0, v_underwaterRainTime.z))*1.1, vec3(14,9,100))*mask;  gl_FragColor = vec4(skyColor, 2.0);
#else
